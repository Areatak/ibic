...
<body <?php if(ICL_LANGUAGE_CODE !== 'en'){?> style="font-family: IranSansWeb, Helvetica,serif;" <?php } ?> <?php body_class(mk_get_body_class(global_get_post_id())); ?> <?php echo get_schema_markup('body'); ?>data-adminbar="<?php echo is_admin_bar_showing() ?>">
	<?php
